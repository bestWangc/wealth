$(function () {
    ...
    function c() {
        ...
        if (k) {
            ...
            var n = '<iframe class="J_iframe" name="iframe' + m + '" width="100%" '+t+' height="100%" src="' + o + '" frameborder="0" data-id="' + o + '" seamless></iframe>';
    ...
    function h() {
        ...
        if ($(this).parents(".J_menuTab").hasClass("active")) {
            if ($(this).parents(".J_menuTab").next(".J_menuTab").size()) {
                ...
                if (n < 0) {
                    $(".page-tabs-content").animate({marginLeft: (n) + "px"}, "fast")
                }
